...
export const serverLogger = (serverLogConfig: ServerLoggerConfig): pino.Logger => {
  return pino(
    {
      timestamp: true,
      level: "trace",
      ...
      transport: {
        targets: [
          ...
          {
            target: "pino-json-transport",
            options: {
              logPath: "./logs/app.json",
            },
            level: serverLogConfig.logLevel ?? "warn",
          },
          ...(serverLogConfig.pino?.transportTargets ? serverLogConfig.pino.transportTargets : []),
          //     target: "pino/file",
          //     options: {
          //       levelKey: "levelLabel",
          //       destination: "./logs/app.json",
